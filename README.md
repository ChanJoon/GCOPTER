...
### #1 Trajectory Planning in race track

In provided **Example 1**, there are no obstacles in Gazebo; it only features a virtual map in rviz for trajectory planning.
